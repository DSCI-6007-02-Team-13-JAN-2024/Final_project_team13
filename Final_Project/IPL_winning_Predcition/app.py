...
def main():
    ...
    if flask.request.method == 'POST':
        ...
        input_variables.Home.replace(['Sunrisers Hyderabad', 'Mumbai Indians', 'Gujarat Titans',
                      'Lucknow Super Gaints', 'Royal Challengers Bangalore',
                      'Kolkata Knight Riders', 'Delhi Capitals', 'Kings XI Punjab',
                      'Chennai Super Kings', 'Rajasthan Royals', 'Deccan Chargers',
                     ],
                      np.arange(0, 14), inplace=True)
        input_variables.Away.replace(['Sunrisers Hyderabad', 'Mumbai Indians', 'Gujarat Titans',
                      'Lucknow Super Gaints', 'Royal Challengers Bangalore',
                      'Kolkata Knight Riders', 'Delhi Capitals', 'Kings XI Punjab',
                      'Chennai Super Kings', 'Rajasthan Royals', 'Deccan Chargers',],
                      np.arange(0, 14), inplace=True)
        #input_variables['toss_winner'] = np.where(input_variables['toss_winner'] == 'Home Team', input_variables['Home'], input_variables['Away'])
        input_variables.toss_winner.replace(['Sunrisers Hyderabad', 'Mumbai Indians', 'Gujarat Titans',
                      'Lucknow Super Gaints', 'Royal Challengers Bangalore',
                      'Kolkata Knight Riders', 'Delhi Capitals', 'Kings XI Punjab',
                      'Chennai Super Kings', 'Rajasthan Royals', 'Deccan Chargers',],
                              np.arange(0, 14), inplace=True)
        ...
        prediction = prediction["Winners"].map({0:'Sunrisers Hyderabad', 1:'Mumbai Indians', 2:'Gujarat Titans',
                      3:'Lucknow Super Gaints', 4:'Royal Challengers Bangalore',
